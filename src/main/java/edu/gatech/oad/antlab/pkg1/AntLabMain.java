 ...
 public class AntLabMain {
    ...
    public void printOutMessage() {
        ...
        String toPrint =
		  ...
		  Person1 p1 = new Person1("Kyle Stachowicz");
		  toPrint += p1.toString("kstachowicz3");
		  //Person2 replace P2 with your name
		  //and gburdell with your gt id
		  Person2 p2 = new Person2("Will Gulian");
		  toPrint += p2.toString("wgulian3");
		  //Person3 replace P3 with your name
		  //and gburdell3 with your gt id
		  Person3 p3 = new Person3("Stephen Tong");
		  toPrint += p3.toString("stong33");
                  //Person4 replace P4 with your name
                  //and gburdell4 with your gt id
                  Person4 p4 = new Person4("Ananth Dandibhotla");
                  toPrint += p4.toString("adandibhotla3");
